        ...
        <body class="text-center">
            ...
            <div class="wrapper">
                        ...
                        <div class="back">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p>Kegiatan Istigosah</p>
                                    <p>Merupakan program kegiatan yang di adakan oleh forum rohis kota  tasikmalaya dari tahun ke tahun.  </p>
                                </div>
                    ...
                    <div class="content">
                        ...
                        <div class="back">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p>Kegiatan ini berlangsung di bulan dzulhijah tepatnya pada hari raya idul adha SMKN 4 Tasikmalaya mengadakan qurban 
                                        yang juga tertera dalam proker OSIS dan MA'RIFAT.
                                    </p>
                                    <ul>
                                        <li>Sakaligus santunan kepada siswa/i yang yatim ataupun piatu.</li>
                                        <li>Sebagai bentuk ibadah kepada allah swt.</li>
                                        <li>Juga sebagai suatu upaya untuk menjaga tali silaturahmi antara sesama umat beragama.</li>
                                    </ul>
                                </div>
                                <div class="location">SMKN 4 Tasikmalaya</div>
                                <div class="price">1 day</div>
                    ...
                    <div class="content">
                        ...
                        <div class="back">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p>Peringatan Tahun Baru Islam</p>
                                    <p>Merupakan Kegiatan yang sering diadakan setiap pergantian tahun baru islam.</p>
                                </div>
                                <div class="location">SMKN 4 Tasikmalaya</div>
                                <div class="price">1 day</div>
                    ...
                    <div class="content">
                        ...
                        <div class="back">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p>Perlombaan Islami</p>
                                    <p>Biasa diadakan disetiap ada acara-acara atau event-event keagamaan.</p>
                                </div>
                                <div class="location">SMKN 4 Tasikmalaya</div>
                                <div class="price">4 day</div>
                        ...
                        <div class="back">
                            <div class="inner">
                                ...
                                <div class="description">
                                    ...
                                    <p>Merupakan kegiatan dimana sebagai bentuk dari rukun iman kepada nabi allah juga 
                                        sebagai peringatan hari lahir nabi muhammad saw yang bertepatan dengan peristiwa penyerangan kota suci mekkah.
                                    </p>
                                </div>
                                <div class="location">SMKN 4 Tasikmalaya</div>
                                <div class="price">1 day</div>
                ...
                <div class="card">
                    ...
                    <div class="content">
                        <div class="front" style="background-image: url('https://wallpaperaccess.com/full/681486.jpg')">
                            <div class="inner">
                                <h2>Pelantikan Pengurus Baru Periode 2021/2022</h2>
                                <div class="rating">
                                    <i class="fa fa-star" aria-hidden="true"></i>
                                    <i class="fa fa-star" aria-hidden="true"></i>
                                    <i class="fa fa-star" aria-hidden="true"></i>
                        ...
                        <div class="back">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p>Pelantikan Calon Pengurus menjadi Pengurus</p>
                                    <p>merupakan acara dimana calon pengurus akan dilantik secara resmi tentunya dengan melewati beberapa tes dan materi.</p>
                                </div>
                                <div class="location">Mesjid Al-Barokah SMKN 4</div>
                                <div class="price">2 day</div>
                ...
                <div class="card">
                    ...
                    <div class="content">
                        <div class="front" style="background-image: url('https://i.pinimg.com/564x/75/66/5e/75665e5f2483cd6fe22f87193298dd6d.jpg')">
                            <div class="inner">
                                <h2>Keputrian</h2>
                                <div class="rating">
                                    <i class="fa fa-star" aria-hidden="true"></i>
                        ...
                        <div class="back">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p>
                                        Kegitan yang dilaksanakan hanya pada setiap hari jum'at mengambil waktu dzuhur biasanya di khususkan untuk siswi dan ibu guru di saat siswa dan bapak guru sedang melaksanakan ibadah sholat jum'at.
                                    </p>
                                </div>
                                <div class="location">SMKN 4 Tasikmalaya</div>
                                <div class="price">1 day</div>
                    ...
                    <div class="content">
                        ...
                        <div class="back">
                            <div class="inner">
                                ...
                                <div class="description">
                                    <p>Kerohanian biasanya dilakuakan sebelum memulai jam pelajaran di hari jum'at</p>
                                </div>
                                <div class="location">SMKN 4 Tasikmalaya</div>
                                <div class="price">1 day</div>
