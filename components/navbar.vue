    ...
    <main>
        <div class="container">
            <div class="menu text-center">
                <li>
                    <NuxtLink class="a" style="text-decoration: none;" to="/">
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-grid-fill" viewBox="0 0 16 16">
                            <path d="M1 2.5A1.5 1.5 0 0 1 2.5 1h3A1.5 1.5 0 0 1 7 2.5v3A1.5 1.5 0 0 1 5.5 7h-3A1.5 1.5 0 0 1 1 5.5v-3zm8 0A1.5 1.5 0 0 1 10.5 1h3A1.5 1.5 0 0 1 15 2.5v3A1.5 1.5 0 0 1 13.5 7h-3A1.5 1.5 0 0 1 9 5.5v-3zm-8 8A1.5 1.5 0 0 1 2.5 9h3A1.5 1.5 0 0 1 7 10.5v3A1.5 1.5 0 0 1 5.5 15h-3A1.5 1.5 0 0 1 1 13.5v-3zm8 0A1.5 1.5 0 0 1 10.5 9h3a1.5 1.5 0 0 1 1.5 1.5v3a1.5 1.5 0 0 1-1.5 1.5h-3A1.5 1.5 0 0 1 9 13.5v-3z"/>
                        </svg>
                    </NuxtLink>
                </li>
                <li>
                    <NuxtLink class="a" style="text-decoration: none;" to="/about">
                ...
                <li>
                    <NuxtLink class="a" style="text-decoration: none;" to="/activation">
                ...
                <li>
                    <NuxtLink class="a" style="text-decoration: none;" to="/archive">
                ...
                <li>
                    <NuxtLink class="a" style="text-decoration: none;" to="/contact">
