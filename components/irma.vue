<template>
    <main>
        ...
        <div class="example-elements">
            ...
            <p data-tooltip="IKATAN REMAJA MESJID">
                IRMA JAWA BARAT
            </p>

            <a href="#" style="text-decoration: none;" 
            data-tooltip="IKATAN REMAJA MESJID MA'RIFAT AL_BAROKAH SMKN 4 TASIKMALAYA"
            data-tooltip-location="right">
                IRMA MA'RIFAT
            </a>
            <a href="#" style="text-decoration: none;">
            <button
            data-tooltip="KLIK UNTUK INFO LEBIH LANJUT"
...
<style scoped>
    ...
    */
    ...
    border-left: 1px solid rgb(229, 255, 0);
    border-right: 1px solid rgb(229, 255, 0);
    padding-left: 5px;
    padding-right: 5px;
    }
